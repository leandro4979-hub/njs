...
let c14n_tsuite = {
    ...
    tests: [
        ...
        { call: (doc) => xml.exclusiveC14n(doc.pdu.elem1, null, false,
                                           'a\tn0\r\nb'),
          expected: `<n1:elem1 xmlns:n0="http://a" xmlns:n1="http://b">foo</n1:elem1>` },
        { doc: `<r xmlns="http://d" xmlns:p="http://p"><p:b>x</p:b></r>`,
          call: (doc) => xml.exclusiveC14n(doc.r.b, null, false, '#default'),
          expected: `<p:b xmlns="http://d" xmlns:p="http://p">x</p:b>` },
        { doc: `<r xmlns="http://d" xmlns:p="http://p"><p:b>x</p:b></r>`,
          call: (doc) => xml.exclusiveC14n(doc.r.b, null, false, ' a  b '),
          expected: `<p:b xmlns:p="http://p">x</p:b>` },
        { call: (doc) => {
              let prefixes = 'n0 n1';
              xml.exclusiveC14n(doc.pdu.elem1, null, false, prefixes);
              return prefixes;
          },
          buffer: false,
          expected: 'n0 n1' },
